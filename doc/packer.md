This is a packer to collecting various of lib and execute files into one single .pak file, and a program will be used to read the .pak file and install it on a certain path.
# pak file format
